...
export default function StepPayment({ formData, onBack }) {
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      // Success! Clear cart and display success screen
      clearCart();
      setOrderSuccess(true);
    } catch (err) {
      console.error('Error confirming order:', err);
      setErrorMsg(err.message || 'Error de conexión. Intente confirmar nuevamente.');
    } finally {
      setConfirming(false);
    }
  };
    ...
    return (
      <div className={styles.successWrapper}>
        ...
        <p className={styles.successText}>
          ¡Pedido confirmado! Te contactaremos pronto por WhatsApp para coordinar el pago.
        </p>
        <div className={styles.successDivider} />
        <a href="/" className="btn-primary" style={{ marginTop: 'var(--space-6)' }}>
          Volver a la Tienda
        </a>
      </div>
    );
      ...
      <div className={styles.layout}>
        ...
        <aside className={styles.sidePanel}>
          ...
          <p className={styles.disclaimer}>
            Al confirmar, procesaremos tu pedido de forma segura. El pago y envío se coordina directamente por WhatsApp.
          </p>
